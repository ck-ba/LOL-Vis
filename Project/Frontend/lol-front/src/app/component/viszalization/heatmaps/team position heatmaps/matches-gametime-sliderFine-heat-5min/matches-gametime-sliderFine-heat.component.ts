...
@Component({
  selector: 'app-matches-gametime-sliderFine-heat',
  templateUrl: './matches-gametime-sliderFine-heat.component.html',
  styleUrls: ['./matches-gametime-sliderFine-heat.component.css']
})
export class MatchesGametimeSliderFineHeatComponent implements OnInit {
