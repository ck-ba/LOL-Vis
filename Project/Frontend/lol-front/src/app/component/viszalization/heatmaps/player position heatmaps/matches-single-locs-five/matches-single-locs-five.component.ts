...
@Component({
  selector: 'app-matches-single-locs-five',
  templateUrl: './matches-single-locs-five.component.html',
  styleUrls: ['./matches-single-locs-five.component.css']
})
export class MatchesSingleLocsFiveComponent implements OnInit {
  ...
  // @ts-ignore
  private mins00To05: LocationList[];
  // @ts-ignore
  private mins05To10: LocationList[];
  // @ts-ignore
  private mins10To15: LocationList[];
  // @ts-ignore
  private mins15To20: LocationList[];
  // @ts-ignore
  private mins20To25: LocationList[];
  // @ts-ignore
  private mins25To30: LocationList[];
  // @ts-ignore
  private mins30To35: LocationList[];
  // @ts-ignore
  private mins35To40: LocationList[];
  // @ts-ignore
  ...
  private prepareData(): void {
    ...
    this.matchlist.forEach((match) => {
      if (this.team === "blue" || this.team === "both") {
        match.teamBlue.champions.forEach((champion) => {
          if (champion.player === this.playerName) {
            champion.positions.forEach((pos) => {
              if (pos.time/1000/60 <= 5) {
    ...
    this.mins00To05 = list05;
    this.mins05To10 = list10;
    this.mins10To15 = list15;
    this.mins15To20 = list20;
    this.mins20To25 = list25;
    this.mins25To30 = list30;
    this.mins30To35 = list35;
    this.mins35To40 = list40;
