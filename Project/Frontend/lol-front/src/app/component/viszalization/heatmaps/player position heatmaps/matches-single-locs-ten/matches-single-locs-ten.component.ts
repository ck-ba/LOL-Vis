...
@Component({
  selector: 'app-matches-single-locs-ten',
  templateUrl: './matches-single-locs-ten.component.html',
  styleUrls: ['./matches-single-locs-ten.component.css']
})
export class MatchesSingleLocsTenComponent implements OnInit {
