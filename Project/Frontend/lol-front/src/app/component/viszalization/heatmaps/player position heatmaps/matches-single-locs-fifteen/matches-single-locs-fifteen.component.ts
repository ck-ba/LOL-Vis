...
@Component({
  selector: 'app-matches-single-locs-fifteen',
  templateUrl: './matches-single-locs-fifteen.component.html',
  styleUrls: ['./matches-single-locs-fifteen.component.css']
})
export class MatchesSingleLocsFifteenComponent implements OnInit {
